...
-- B[2]	=>  Location: PIN_E25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[3]	=>  Location: PIN_A17,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[4]	=>  Location: PIN_E5,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[5]	=>  Location: PIN_G13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[6]	=>  Location: PIN_R25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[7]	=>  Location: PIN_AD15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF latch2 IS
...
-- Equation(s):
-- \Q[0]~reg0feeder_combout\ = \B~combout\(0)
...
-- Equation(s):
-- \Q[2]~reg0feeder_combout\ = \B~combout\(2)
...
-- Equation(s):
-- \Q[3]~reg0feeder_combout\ = \B~combout\(3)
...
-- Equation(s):
-- \Q[4]~reg0feeder_combout\ = \B~combout\(4)
...
-- Equation(s):
-- \Q[5]~reg0feeder_combout\ = \B~combout\(5)
...
-- Equation(s):
-- \Q[6]~reg0feeder_combout\ = \B~combout\(6)
